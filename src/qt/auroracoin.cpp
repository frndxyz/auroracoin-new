...
void DigiByteApplication::createSplashScreen(const NetworkStyle *networkStyle)
{
    ...
    splash->show();
    connect(this, &DigiByteApplication::splashFinished, splash, &SplashScreen::slotFinish);
...
void DigiByteApplication::startThread()
{
    ...
    connect(this, &DigiByteApplication::stopThread, executor, &QObject::deleteLater);
    connect(this, &DigiByteApplication::stopThread, coreThread, &QThread::quit);
...
void DigiByteApplication::addWallet(WalletModel* walletModel)
{
    ...
    connect(walletModel, &WalletModel::unload, this, &DigiByteApplication::removeWallet);
